...
- 마지막 완료 PR: feat: v3 자연 톤 + 별점 폐기·'길' 체계 통일 + 여정 타임라인 (#62)
- 진행 중 PR: fix: 카드 등급 칩 한글 세로 정렬 수정 (#63, 리뷰 대기)
...
- 등급 칩 한글 세로 정렬 수정(.review-card__tags align-items: center) — PR #63(리뷰 대기)
