...
- 마지막 완료 PR: feat: 내 기록 전체 로드로 여정 선·월 점프 일관화 (#67)
- 진행 중 PR: style: 전체 탭 카드 v3 리디자인 main 재반영 (#69, 리뷰 대기 — #68이 스택 base로 머지돼 main 누락분 재적용)
...
- 전체 탭 카드 리디자인(포스터 없음 박스 제거, 스파인 등급 색, 시리얼 제거) — PR #68→main 재반영 #69(대기)
